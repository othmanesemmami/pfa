...
public class Cadeau extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cadeau);
        ...
        btnPanier.setOnClickListener(v -> {
            Intent intent = new Intent(Cadeau.this, CartActivity.class);
    ...
    private void initializeProducts() {
        ...
        productInfoMap.put(1, new ProductInfo(1, "Coffret Parfum", 450.00, 1));
        productInfoMap.put(2, new ProductInfo(2, "Boîte Chocolats", 120.00, 1));
        productInfoMap.put(3, new ProductInfo(3, "Carte Cadeau", 200.00, 1));
        productInfoMap.put(4, new ProductInfo(4, "Bouquet Fleurs", 180.00, 1));
    }
    ...
    private void setupBottomNavigation() {
        ...
        homeNav.setOnClickListener(v -> {
            Intent intent = new Intent(Cadeau.this, MainActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });

        offresNav.setOnClickListener(v -> {
            Intent intent = new Intent(Cadeau.this, Offre.class);
            startActivity(intent);
        });
        ...
        profilNav.setOnClickListener(v -> {
            ...
            Toast.makeText(Cadeau.this, "Profil utilisateur", Toast.LENGTH_SHORT).show();
        });
    }
