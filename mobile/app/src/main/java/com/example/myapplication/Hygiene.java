...
public class Hygiene extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPanier.setOnClickListener(v -> {
            Intent intent = new Intent(Hygiene.this, CartActivity.class);
    ...
    private void initializeProducts() {
        // Définir les informations des produits d'hygiène
        productInfoMap.put(1, new ProductInfo(1, "Gel Douche", 35.00, 1));
        productInfoMap.put(2, new ProductInfo(2, "Shampooing", 45.00, 1));
        productInfoMap.put(3, new ProductInfo(3, "Dentifrice", 25.00, 1));
        productInfoMap.put(4, new ProductInfo(4, "Déodorant", 30.00, 1));
    }
    ...
    private void setupBottomNavigation() {
        ...
        homeNav.setOnClickListener(v -> {
            Intent intent = new Intent(Hygiene.this, MainActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });

        offresNav.setOnClickListener(v -> {
            Intent intent = new Intent(Hygiene.this, Offre.class);
            startActivity(intent);
        });

        historiqueNav.setOnClickListener(v -> {
            // Implémenter la navigation vers l'historique
            Toast.makeText(Hygiene.this, "Historique des commandes", Toast.LENGTH_SHORT).show();
        });

        profilNav.setOnClickListener(v -> {
            // Implémenter la navigation vers le profil
            Toast.makeText(Hygiene.this, "Profil utilisateur", Toast.LENGTH_SHORT).show();
        });
    }
