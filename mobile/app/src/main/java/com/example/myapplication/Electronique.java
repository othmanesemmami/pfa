...
public class Electronique extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electronique);
        ...
        btnPanier.setOnClickListener(v -> {
            Intent intent = new Intent(Electronique.this, CartActivity.class);
    ...
    private void initializeProducts() {
        // Définir les informations des produits électroniques
        productInfoMap.put(1, new ProductInfo(1, "Écouteurs Sans Fil", 350.00, 1));
        productInfoMap.put(2, new ProductInfo(2, "Chargeur Rapide", 150.00, 1));
        productInfoMap.put(3, new ProductInfo(3, "Batterie Externe", 200.00, 1));
        productInfoMap.put(4, new ProductInfo(4, "Câble USB Type-C", 80.00, 1));
    }
    ...
    private void setupBottomNavigation() {
        ...
        homeNav.setOnClickListener(v -> {
            Intent intent = new Intent(Electronique.this, MainActivity.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
            startActivity(intent);
        });

        offresNav.setOnClickListener(v -> {
            Intent intent = new Intent(Electronique.this, Offre.class);
            startActivity(intent);
        });
        ...
        profilNav.setOnClickListener(v -> {
            ...
            Toast.makeText(Electronique.this, "Profil utilisateur", Toast.LENGTH_SHORT).show();
        });
    }
